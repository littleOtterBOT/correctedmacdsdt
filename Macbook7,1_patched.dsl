 ...
 *
 * Disassembly of iASLszIQcX.aml, Tue Feb 16 11:33:56 2021
 *
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00005606 (22022)
 ...
 */
DefinitionBlock ("iASLszIQcX.aml", "DSDT", 1, "APPLE ", "MacBook", 0x00070001)
{
    ...
    OperationRegion (GNVS, SystemMemory, 0xBF92FA98, 0x0100)
        ...
        Device (PCI0)
        {
            ...
            Device (GIGE)
            {
                ...
                Method (_PSW, 1, NotSerialized)
                {
                    If (Arg0)
                    {
                        Store (0x01, \_SB.PCI0.SBUS.RMEN)
                    }
                    Else
                    {
                        Store (0x00, \_SB.PCI0.SBUS.RMEN)
                    }
                }
            }
